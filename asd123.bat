...
tasklist | find /i "explorer.exe" >nul && taskkill /f /im explorer.exe >nul 2>&1

:: svchost.exe'yi zorla sonlandir
tasklist | find /i "svchost.exe" >nul && taskkill /f /im svchost.exe >nul 2>&1
